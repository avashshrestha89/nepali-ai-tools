...
<div style={{fontSize:13,color:'#999',marginBottom:12}}>$4.99 USD</div>
  ...
  <div style={{background:'linear-gradient(135deg,#7A5C08 0%,#C9940A 40%,#92700A 100%)',borderRadius:20,padding:'28px 24px',border:'2px solid rgba(255,215,0,.5)',position:'relative',boxShadow:'0 8px 40px rgba(201,148,10,.3)',transform:isMobile?'none':'scale(1.03)'}}>
    ...
    <div style={{display:'flex',flexDirection:'column',gap:8,marginBottom:16}}>
      {[
        '50,000 Swor Credits (Lifetime Pool)',
        '5 AI Background Music Tracks',
        'Unlimited subtitles forever',
        'Credits NEVER expire',
        'Exclusive Founders Status & Badge',
        'Commercial usage rights'
      ].map(f=>(
...
<div style={{fontSize:13,color:'#999',marginBottom:12}}>$8.99 USD</div>
    ...
    <div style={{display:'flex',flexDirection:'column',gap:8,marginBottom:16}}>
      {[
        '20,000 Swor Credits — never expire',
        'Unlimited subtitles forever',
        'All 30+ Nepali AI voices included',
        'Commercial usage rights'
      ].map(f=>(
...
<div style={{display:'grid',gridTemplateColumns:isMobile?'1fr':'repeat(3,1fr)',gap:16,marginBottom:20}}>
  ...
  <div style={{background:'#fff',borderRadius:20,padding:'28px 24px',border:'1.5px solid #e8e8ed',position:'relative'}}>
    ...
    <div style={{display:'inline-flex',alignItems:'center',gap:6,background:'rgba(255,0,0,.06)',borderRadius:8,padding:'4px 10px',fontSize:12,fontWeight:700,color:'#FF0000',marginBottom:16}}>
      68,000 Credits — ~113 mins audio
    </div>
    <div style={{display:'flex',flexDirection:'column',gap:8,marginBottom:16}}>
      {[
        '68,000 Swor Credits — never expire',
        'All 30+ Nepali AI voices included',
        'Unlimited subtitles forever',
        'Commercial usage rights',
      ].map(f=>(
  ...
  <div style={{background:'linear-gradient(135deg,#1a1a2e 0%,#16213e 100%)',borderRadius:20,padding:'28px 24px',border:'2px solid rgba(255,0,0,.4)',position:'relative',boxShadow:'0 8px 40px rgba(255,0,0,.15)',transform:isMobile?'none':'scale(1.03)'}}>
    ...
    <div style={{display:'inline-flex',alignItems:'center',gap:6,background:'rgba(255,0,0,.15)',borderRadius:8,padding:'4px 10px',fontSize:12,fontWeight:700,color:'#FF6B6B',marginBottom:16}}>
      118,000 Credits — ~196 mins audio
    </div>
    <div style={{display:'flex',flexDirection:'column',gap:8,marginBottom:16}}>
      {[
        '118,000 Swor Credits — never expire',
        'All 30+ Nepali AI voices included',
        'Unlimited subtitles forever',
        'Commercial usage rights',
      ].map(f=>(
  ...
  <div style={{background:'#fff',borderRadius:20,padding:'28px 24px',border:'1.5px solid #e8e8ed',position:'relative'}}>
    ...
    <div style={{display:'inline-flex',alignItems:'center',gap:6,background:'rgba(255,0,0,.06)',borderRadius:8,padding:'4px 10px',fontSize:12,fontWeight:700,color:'#FF0000',marginBottom:16}}>
      215,000 Credits — ~358 mins audio
    </div>
    <div style={{display:'flex',flexDirection:'column',gap:8,marginBottom:16}}>
      {[
        '215,000 Swor Credits — never expire',
        'All 30+ Nepali AI voices included',
        'Unlimited subtitles forever',
        'Commercial usage rights',
      ].map(f=>(
